...
import { SlidersHorizontal, MapPin, Grid2x2, Grid3x3, UtensilsCrossed, ShoppingCart, Pill, Coffee, Home, Shirt, Laptop, Sparkles, Store as StoreIcon } from "lucide-react";
