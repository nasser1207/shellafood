	...
	return (
		<div className="min-h-screen bg-gray-50" dir={direction}>
			<div className="max-w-8xl mx-auto px-3 sm:px-4 lg:px-8 py-4 sm:py-6 lg:py-8">
				...
				{/* Expiration Alert */}
				<div className={`mb-6 flex items-center gap-3 rounded-xl bg-yellow-50 border border-yellow-200 p-4 ${isArabic ? 'flex-row' : 'flex-row'}`}>
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
					{currentOffers.length > 0 ? (
						...
						<div className="col-span-1 sm:col-span-2 lg:col-span-3 bg-white rounded-xl shadow-sm border border-gray-200 p-8 text-center">
