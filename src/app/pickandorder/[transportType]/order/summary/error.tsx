...
/**
 * Error Component for Order Summary Page
...
export default function OrderSummaryError({
	...
	useEffect(() => {
		...
		console.error("Order Summary page error:", error);
	}, [error]);
		...
		>
			<div className={`text-center max-w-md ${isArabic ? "text-right" : "text-left"}`}>
				...
				<p className="text-lg text-gray-600 dark:text-gray-400 mb-6">
					{isArabic
						? "عذراً، حدث خطأ أثناء تحميل ملخص الطلب. يرجى المحاولة مرة أخرى."
						: "Sorry, an error occurred while loading the order summary. Please try again."}
				</p>
