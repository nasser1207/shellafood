...
/**
 * Error Component for Order Confirmation Page
		...
		>
			<div className={`text-center max-w-md ${isArabic ? "text-right" : "text-left"}`}>
				...
				<p className="text-lg text-gray-600 dark:text-gray-400 mb-6">
					{isArabic
						? "عذراً، حدث خطأ أثناء معالجة تأكيد الطلب. يرجى المحاولة مرة أخرى."
						: "Sorry, an error occurred while processing the order confirmation. Please try again."}
				</p>
