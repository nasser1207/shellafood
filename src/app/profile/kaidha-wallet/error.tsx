...
export default function KaidhaWalletError({
	error,
	reset,
}: {
	...
	useEffect(() => {
		console.error("Kaidha wallet page error:", error);
	}, [error]);
			...
			<div className="max-w-md text-center">
				<div className="mb-6 flex justify-center">
					<div className="rounded-full bg-red-100 p-4">
						<Wallet className="h-12 w-12 text-red-600" />
					</div>
				</div>
				...
				<p className="mb-6 text-lg text-gray-600">
					عذراً، حدث خطأ أثناء تحميل صفحة محفظة قيدها. يرجى المحاولة مرة أخرى.
				</p>
