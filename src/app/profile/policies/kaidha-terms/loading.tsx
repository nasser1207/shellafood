...
/**
 * Kaidha Terms Loading Component
 * Responsive skeleton loading for kaidha terms page with green theme
 */
export default function KaidhaTermsLoading() {
			...
			<div className="max-w-8xl mx-auto px-3 sm:px-4 lg:px-8 py-4 sm:py-6 lg:py-8">
				...
				<div className="fixed bottom-8 left-1/2 transform -translate-x-1/2 bg-white dark:bg-gray-800 rounded-full px-6 py-3 shadow-lg border border-gray-200 dark:border-gray-700">
					<div className="flex items-center gap-3">
						...
						<span className="text-sm text-gray-600 dark:text-gray-300 font-medium">جاري تحميل شروط قيدها...</span>
					</div>
				</div>
			</div>
		</div>
