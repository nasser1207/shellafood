...
export default function AccountInfoError({
	error,
	reset,
}: {
	...
	useEffect(() => {
		console.error("Account info page error:", error);
	}, [error]);
		...
		<div className="flex min-h-screen flex-col items-center justify-center bg-gray-50 px-4 py-16">
			<div className="max-w-md text-center">
				...
				<p className="mb-6 text-lg text-gray-600">
					عذراً، حدث خطأ أثناء تحميل صفحة معلومات الحساب. يرجى المحاولة مرة أخرى.
				</p>
