...
import { RefreshCw, Home, Truck } from "lucide-react";
...
export default function DriverError({ error, reset }: ErrorProps) {
	return (
		<div className="min-h-screen bg-gray-50 flex items-center justify-center px-4" dir="rtl">
			<div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
				...
				<p className="text-gray-600 mb-6">
					واجهنا مشكلة في تحميل صفحة التسجيل. قد يكون هذا بسبب مشكلة في الشبكة أو مشكلة مؤقتة في الخادم.
				</p>
