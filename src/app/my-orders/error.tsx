...
export default function MyOrdersError({
	...
	return (
		<div className="flex min-h-screen flex-col items-center justify-center bg-gray-50 dark:bg-gray-900 px-4 py-16">
			<div className="max-w-md text-center">
				...
				<p className="mb-6 text-lg text-gray-600 dark:text-gray-400">
					عذراً، حدث خطأ أثناء تحميل صفحة طلباتي. يرجى المحاولة مرة أخرى.
				</p>

				{/* Error Details (Development only) */}
				{process.env.NODE_ENV === "development" && (
					<div className="mb-6 rounded-lg bg-red-50 dark:bg-red-900/20 p-4 text-right">
