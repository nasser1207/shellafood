	...
	return (
		<div className={`min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center px-4 ${isArabic ? "rtl" : "ltr"}`} dir={isArabic ? "rtl" : "ltr"}>
			<div className="max-w-2xl w-full text-center">
				{/* 404 Number */}
				<div className="mb-8">
					<h1 className="text-9xl sm:text-[12rem] font-bold text-gray-200 dark:text-gray-800 select-none">
						404
					</h1>
				</div>
				...
				<div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
					...
					<Link
						href="/serve-me"
						className="group inline-flex items-center gap-3 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-900 dark:text-gray-100 px-8 py-4 rounded-lg font-semibold transition-all duration-200 border-2 border-gray-300 dark:border-gray-600 hover:border-green-600 dark:hover:border-green-500"
					>
