// app/previously-ordered-stores/error.tsx
"use client";
...
export default function PreviouslyOrderedStoresError({ error, reset }: ErrorProps) {
	return (
		<div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center px-4" dir="rtl">
			<div className="max-w-md w-full bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 text-center">
				...
				<p className="text-gray-600 dark:text-gray-400 mb-6">
					واجهنا مشكلة في تحميل متاجرك المفضلة. قد يكون هذا بسبب مشكلة في الشبكة أو مشكلة مؤقتة في الخادم.
				</p>
