...
**مشروع Shella Food** هو تطبيق ويب شامل مبني بتقنية Next.js 14 يوفر منصة متعددة الخدمات للتوصيل والشراكات التجارية. يدعم المشروع اللغتين العربية والإنجليزية (RTL/LTR) مع نظام توثيق متقدم ونظام إدارة متكامل للمتاجر والمنتجات والطلبات.
...
### UI Components
- **@radix-ui/react-*** - مكونات UI متاحة
- **Lucide React** - مكتبة أيقونات حديثة
- **React Hook Form** - إدارة النماذج
- **React Phone Input 2** - إدخال أرقام هواتف دولية
- **Shadcn/ui** - مكونات UI قابلة للتخصيص

### Maps & Location
- **@react-google-maps/api** - خرائط جوجل تفاعلية
- **Google Maps Distance Matrix API** - حساب المسافات
- **Geolocation API** - تحديد الموقع

### File Management
- **UploadThing** - رفع الملفات (صور، فيديو)
